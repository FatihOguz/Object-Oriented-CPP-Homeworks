...
void test(vector <Classroom> classrooms,int classrooms_size,vector <Course> courses ,int courses_size,vector <Lecturer> lecturers,int lecturers_size,Administrator administrator)
{
	int p,cod,cre,hour;
	string arr,n,fie;
